...
# ╔═╡ 4968e578-a536-4dcf-9e82-afdfde091b5f
md"""
# TODO: 
- load 2018 data (from case file)
- repeat analysis on 2018 data (a general case file)
"""
...
# ╔═╡ 5e9cc8ed-a874-4323-b176-67a9b8adb812
results[2]

# ╔═╡ b7ae1594-b8af-408b-bc0c-9404ea9fb7f2
DateTime("2001-01-01-01", "yy-mm-dd-HH")

# ╔═╡ 81898fc0-be77-4941-848e-581fb8cfb1ed
analysis.get_nodal_mefs(results[2])
...
# ╔═╡ 60a3c9f5-c2f7-4bd1-bac3-883e26dba009
whichdates=d -> hour(d) == hr

# ╔═╡ 3c0cc4e9-5a75-40eb-a944-1673ee539d41
whichdates(DateTime("2001-01-01-01", "yy-mm-dd-HH"))
