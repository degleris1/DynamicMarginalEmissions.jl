...
PATH_NETWORK = joinpath(datapath, "nrel/WECC240_2018_Generation_scheduling.xlsx")
PATH_GIS = joinpath(datapath, "nrel/Bus GIS.xlsx")
PATH_LOAD = joinpath(datapath, "nrel/Time_Series/TIMESERIES_DAUC_LOAD_V1.csv")
PATH_GEN = joinpath(datapath, "nrel/Time_Series/TIMESERIES_DAUC_GEN_V1.csv")
